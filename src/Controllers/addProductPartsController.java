...
public class addProductPartsController implements Initializable {
     ...
     * @throws IOException
     */
    @FXML void addProductSaveClick(ActionEvent actionEvent) throws IOException {
     ...
     * @throws IOException
     */
    @FXML void addProductCancelButtonClick(ActionEvent actionEvent) throws IOException {
     ...
     * @param actionEvent
     */
    @FXML void addProductPartClick(ActionEvent actionEvent) {
     ...
     * @param actionEvent
     */
    @FXML void removeAssociatedPartClick(ActionEvent actionEvent) {
        ...
        allParts = AssociatedPartsTable.getItems();
        //gets only selected Items
        partsSelected = AssociatedPartsTable.getSelectionModel().getSelectedItems();
     ...
     * @param actionEvent
     */
    @FXML void productPartSearch(ActionEvent actionEvent)
    {
